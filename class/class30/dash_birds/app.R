...
bird_data_by_record_id_clean <-
  read_csv(here("dash_birds/bird_data_by_record_id_clean.csv"))

ship_data_by_record_id_clean <-
  read_csv(here("dash_birds/ship_data_by_record_id_clean.csv"))

bird_data_codes_clean <-
  read_csv(here("dash_birds/bird_data_codes_clean.csv"))

ship_data_codes_clean <-
  read_csv(here("dash_birds/ship_data_codes_clean.csv"))
